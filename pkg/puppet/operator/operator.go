...
import (
	...
	"github.com/operator-framework/operator-sdk/pkg/puppet/flags"
...
func Run(done chan error, mgr manager.Manager, f *flags.PuppetOperatorFlags) {
...
func applyFlagsToControllerOptions(f *flags.PuppetOperatorFlags, o *controller.Options) {
