...
// PuppetOperatorFlags - Options to be used by an puppet operator
type PuppetOperatorFlags struct {
	ReconcilePeriod time.Duration
	WatchesFile     string
}

// AddTo - Add the puppet operator flags to the the flagset
// helpTextPrefix will allow you add a prefix to default help text. Joined by a space.
func AddTo(flagSet *pflag.FlagSet, helpTextPrefix ...string) *PuppetOperatorFlags {
	aof := &PuppetOperatorFlags{}
