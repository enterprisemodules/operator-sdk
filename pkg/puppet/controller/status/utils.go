...
const (
	...
	// FailedReason - Condition is failed due to puppet failure
	FailedReason = "Failed"
...
func NewCondition(condType ConditionType, status v1.ConditionStatus, puppetResult *PuppetResult, reason, message string) *Condition {
	return &Condition{
		Type:               condType,
		Status:             status,
